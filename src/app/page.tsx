...
const featuredServices = [
  ...
  },
  {
    ...
    description: "Indulge in a full treatment: soak, exfoliation, mask, massage, and polish of your choice.",
    price: "$65",
    duration: "60 min",
  },
  {
    name: "Gel-X Extensions",
    description: "Soft gel extensions for natural-looking length. Lightweight and flexible.",
    price: "$80",
    duration: "60 min",
  },
  {
    name: "Luxury Spa Pedicure",
    description: "A full foot treatment with hot stone massage, mask, and your choice of polish.",
    price: "$75",
    duration: "60 min",
  },
];
...
const testimonials = [
  {
    quote: "Absolutely the best nail experience I've ever had. The atmosphere is so calming and the results were stunning.",
    name: "Sarah M.",
    stars: 5,
  },
  {
    quote: "The gel manicure lasted almost a month with zero chipping. I won't go anywhere else.",
    name: "Jessica T.",
    stars: 5,
  },
  {
    quote: "Professional, hygienic, and genuinely relaxing. The spa pedicure was heaven.",
    name: "Alyssa R.",
    stars: 5,
  },
];
...
const galleryColors = [
  { bg: "bg-blush", h: "h-56" },
  { bg: "bg-rose/40", h: "h-40" },
  { bg: "bg-almond", h: "h-64" },
  { bg: "bg-blush/60", h: "h-48" },
  { bg: "bg-rose/30", h: "h-52" },
  { bg: "bg-almond/80", h: "h-44" },
];
...
export default function Home() {
  return (
    <>
      {/* ── Hero ── */}
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 bg-gradient-to-br from-charcoal via-charcoal to-deep-berry overflow-hidden">
        {/* Subtle texture overlay */}
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(ellipse_at_top_right,_#C4A265,_transparent_60%)]" />
        ...
        >
          <motion.p variants={fadeUp} className="text-xs uppercase tracking-[0.25em] text-gold font-semibold mb-6">
          ...
          >
            Elegance at Your<br />Fingertips
          </motion.h1>

          <motion.p variants={fadeUp} className="text-base md:text-lg text-white/60 max-w-xl mx-auto mb-10 leading-relaxed">
            A sanctuary for those who appreciate the finer details. Premium nail care delivered with warmth, precision, and artistry.
          </motion.p>
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/services"
              className="px-8 py-3.5 rounded-full border border-white/30 text-white font-semibold text-sm uppercase tracking-widest hover:border-white/70 hover:scale-105 transition-all duration-200"
            >
              View Services
            </Link>
          </motion.div>
      ...
      <section className="py-24 px-6 md:px-12 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            <p className="text-muted text-sm uppercase tracking-widest">Photo Coming Soon</p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={stagger} className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {galleryColors.map((item, i) => (
                <motion.div
                  key={i}
                  variants={fadeUp}
                  className={`rounded-2xl ${item.bg} ${item.h} w-full`}
                />
              ))}
            </motion.div>
            ...
            <motion.div variants={stagger} className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {testimonials.map((t) => (
                ...
                >
                  ...
                  <p className="text-charcoal/80 text-sm leading-relaxed mb-5 italic">"{t.quote}"</p>
                  <p className="text-xs uppercase tracking-[0.15em] text-muted font-semibold">{t.name}</p>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
      ...
      <section className="py-28 px-6 md:px-12 bg-gradient-to-br from-blush/40 via-warm-cream to-almond">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="font-display text-4xl md:text-5xl text-charcoal font-semibold mb-5">
            Ready for Your Next Appointment?
          </motion.h2>
          <motion.p variants={fadeUp} className="text-muted mb-10 leading-relaxed">
            Treat yourself to a moment of luxury. Our team is ready to make you feel your absolute best.
          </motion.p>
          <motion.div variants={fadeUp}>
            <Link
              href="/special"
